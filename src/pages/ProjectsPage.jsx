...
const projects = [
  ...
  {
    title: 'Career Portal',
    description: 'A dynamic Job Portal platform built with Vue 3, featuring job seeker to view jobs and apply for them, and full access for admin to control the website.',
    src: '/img/project/career.png',
    ctaText: 'Visit',
    ctaLink: 'https://careers.frisidea.com/',
    content: () => {
      return (
        <div className="overflow-auto custom-scrollbar w-full">
          <motion.p className="mr-3" variants={paragraphVariants} initial="hidden" animate="visible">
            Built with Vue, this platform serves as a comprehensive and user-friendly blog. Users can register, login, and interact with posts through comments and likes. It includes advanced search and sorting by date or tags, trending
            categories, and the latest comments, with embedded YouTube videos enhancing the multimedia experience. The admin side, using MySQL, allows editors to create, edit, and moderate posts, categories, and user profiles, while
            administrators manage all platform operations for a smooth, efficient experience.
            <br />
          </motion.p>
          <div className="flex flex-wrap justify-center mx-auto px-5 pt-2 pb-10 items-center justify-center gap-5">
            {[
    ...
    content: () => {
      return (
        <div className="overflow-auto custom-scrollbar">
          ...
          <div className="flex flex-wrap justify-center mx-auto px-5 pt-2 pb-10 items-center justify-center gap-2">
            {[
    ...
    content: () => {
      return (
        <div className="overflow-auto custom-scrollbar">
          ...
          <div className="flex flex-wrap justify-center mx-auto px-5 pt-2 pb-4 items-center justify-center gap-5">
  ...
  // odrin app
  {
    title: 'Ordering a drink Android Application',
        ...
        {showContent && (
          <div className="container mx-auto py-10 px-6 relative z-10">
            ...
            <motion.div initial="hidden" animate="visible" variants={entranceVariants}>
              <ExpandableCard cards={projects} variants={entranceVariants} initial="hidden" animate="visible" />
            </motion.div>
          </div>
        )}
      </AnimatePresence>
